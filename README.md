...
```
npm create cloudflare@latest -- --template=cloudflare/templates/zcj
```

A live public deployment of this template is available at [https://zcj.templates.workers.dev](https://zcj.templates.workers.dev)
